defmodule MatchingServiceStopLimitOrderTest do
  ...
  test "create/1 stop limit sell order save", c do
  ...
  test "create/1 stop limit buy order buy", c do
    # when: a stop limit order is created
  ...
  test "create/1 stop limit sell order activate", c do
  ...
  test "create/1 stop limit buy order activate", c do
    # when: a stop limit order is created and then a crossing trade occurs
  ...
  test "create/1 stop limit sell order non crossing ", c do
  ...
  test "create/1 stop limit buy order non crossing ", c do
    # when: a stop limit order is created and then a non-crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :BUY, 10, 2, :GTC)
    MatchingService.create(c.trading_account2, "BTC_EUR", :LIMIT, :BUY, 11, 1, :GTC)
    MatchingService.create(c.trading_account, "BTC_EUR", :LIMIT, :SELL, 11, 1, :GTC)
  ...
  test "create/1 stop limit sell order activate and settle", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :SELL, 10, 2, :GTC)
    MatchingService.create(c.trading_account, "BTC_EUR", :LIMIT, :SELL, 10, 1, :GTC)
  ...
  test "create/1 stop limit buy order activate and settle", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :BUY, 10, 2, :GTC)
  ...
  test "create/1 stop limit sell order activate and settle opposite side", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :SELL, 10, 2, :GTC)
    MatchingService.create(c.trading_account2, "BTC_EUR", :LIMIT, :BUY, 10, 3, :GTC)
    MatchingService.create(c.trading_account, "BTC_EUR", :LIMIT, :SELL, 10, 1, :GTC)
  ...
  test "create/1 stop limit buy order activate and settle opposite side", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :BUY, 10, 2, :GTC)
    MatchingService.create(c.trading_account2, "BTC_EUR", :LIMIT, :SELL, 10, 3, :GTC)
    MatchingService.create(c.trading_account, "BTC_EUR", :LIMIT, :BUY, 10, 1, :GTC)
  ...
  test "create/1 stop limit sell order activate and settle before worse price orders", c do
    # when: a stop limit order is created and then a crossing trade occurs
  ...
  test "create/1 stop limit buy order activate and settle before worse price orders", c do
    # when: a stop limit order is created and then a crossing trade occurs
  ...
  test "create/1 stop limit sell order activate by market and settle", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :SELL, 10, 2, :GTC)
  ...
  test "create/1 stop limit buy order activate by market and settle", c do
    # when: a stop limit order is created and then a crossing trade occurs
    MatchingService.create(c.trading_account, "BTC_EUR", :STOPLIMIT, :BUY, 10, 2, :GTC)
