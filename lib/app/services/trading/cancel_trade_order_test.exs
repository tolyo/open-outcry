defmodule CancelTradeOrderTest do
  use DataCase
  import TestUtils

  test "cancel_trade_order/1" do
  ...
  test "cancel_trade_order/1 with multiple orders" do
    # given: an existing trade limit order
    trading_account = acc()
  ...
  test "cancel_trade_order/1 with partially executed order" do
    # given: an existing trade limit order
    trading_account = acc()
