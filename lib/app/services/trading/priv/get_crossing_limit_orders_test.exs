defmodule GetCrossingLimitOrdersTest do
  use DataCase

  import TestUtils

  test "get_crossing_limit_orders/3 test price SELL side" do
    # given:
    trading_account = acc()
  ...
  # test "get_crossing_limit_orders/3 test price BUY side" do
  #   # should return none
  ...
  # """
  # test "get_crossing_limit_orders/3 test ordering SELL side" do
  #   # should return none
  #   assert MatchingServiceTestHelpers.get_crossing_limit_orders(1, :SELL, 10.00) == []
  ...
  #   and by price where where highest prices are selected first down to but now below limit price.
  # """
  # test "get_crossing_limit_orders/3 test ordering BUY side" do
  #   # should return none
  #   assert MatchingServiceTestHelpers.get_crossing_limit_orders(1, :BUY, 10.00) == []
