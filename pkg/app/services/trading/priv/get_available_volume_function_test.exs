defmodule GetAvailableVolumeFunctionTest do
  use DataCase

  import MatchingServiceTestHelpers
  import TestUtils

  test "get_available_limit_volume/3 empty" do
    # should return none
  ...
  """
  test "get_available_limit_volume/3 sell side single order" do
  ...
  test "get_available_limit_volume/3 sell side multiple orders same price" do
    # when given a new sell order
    trading_account = acc()
  ...
  test "get_available_limit_volume/3 sell side multiple orders different prices" do
  ...
  """
  test "get_available_limit_volume/3 buy side single order" do
  ...
  test "get_available_limit_volume/3 buy side multiple orders same price" do
  ...
  test "get_available_limit_volume/3 buy side multiple orders different prices" do
    # when given a new sell order
    trading_account = acc()
    MatchingService.create(trading_account, "BTC_EUR", :LIMIT, :BUY, 10, 10, :GTC)
