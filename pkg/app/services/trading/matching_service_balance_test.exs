defmodule MatchingServiceBalanceTest do
  use DataCase

  test "process/1 limit sell order save with reserved balance" do
    # given:
  ...
  test "process/1 limit buy order save with reserved balance" do
    # given:
    application_entity_id = TestUtils.create_client()
  ...
  test "process/1 limit sell order against matching buy order with funds transfer" do
    # given:
    # -- a seller
    ...
    assert DB.query_val("SELECT COUNT(*) FROM payment") == 8
