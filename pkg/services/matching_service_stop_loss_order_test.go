...
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderSave() {
	...
	res, _ := ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 100, "GTC")
	...
	assert.Equal(100.00, FindCurrencyAccountByAppEntityIdAndCurrencyName(assert.appEntity1, "BTC").AmountReserved)
}

func (assert *ServiceTestSuite) TestCreateStoLossBuyOrderBuy() {

	// when: a stop loss order is created
	res, _ := ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Buy, 10, 100, "GTC")
	...
	assert.Equal(1000.00, FindCurrencyAccountByAppEntityIdAndCurrencyName(assert.appEntity1, "EUR").AmountReserved)
}
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderActivate() {
	...
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 2, "GTC")

	// then
	assert.Equal(2.0, FindCurrencyAccountByAppEntityIdAndCurrencyName(assert.appEntity1, "BTC").AmountReserved)

	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 10, 1, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLosBuyOrderActivate() {
	...
	// when: a stop loss order is created and then a crossing trade occurs
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Buy, 10, 2, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 10, 1, "GTC")

	assert.Equal(20.0, FindCurrencyAccountByAppEntityIdAndCurrencyName(assert.appEntity1, "EUR").AmountReserved)
...
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderNonCrossing() {
	...
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 2, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 11, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 11, 1, "GTC")
	...
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 9, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 9, 1, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderActivateAndSettle() {
	...
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 2, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 10, 3, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLossBuyOrderActivateAndSettle() {
	...
	// when: a stop loss order is created and then a crossing trade occurs
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Buy, 10, 20, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Buy, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Sell, 10, 3, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderActivateAndSettleBeforeWorsePriceOrders() {
	...
	// when: a stop loss order is created and then a crossing trade occurs
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 11, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Sell, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 11, 3, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLossBuyOrderActivateAndSettleBeforeWorsePriceOrders() {
	...
	// when: a stop loss order is created and then a crossing trade occurs
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Buy, 10, 10, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Buy, 9, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", "LIMIT", Buy, 10, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Sell, 9, 3, "GTC")
...
func (assert *ServiceTestSuite) TestCreateStopLossSellOrderActivateByMarketAndSettle() {
	...
	// when: a stop loss order is created and then a crossing trade occurs
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", StopLoss, Sell, 10, 2, "GTC")
	ProcessTradeOrder(assert.instrumentAccount1, "BTC_EUR", Market, Sell, 0, 1, "GTC")
	ProcessTradeOrder(assert.instrumentAccount2, "BTC_EUR", "LIMIT", Buy, 10, 3, "GTC")
