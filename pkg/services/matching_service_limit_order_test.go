...
func (assert *ServiceTestSuite) TestProcessLimitSellOrderSave() {
	...
	res, _ := ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Sell, 10.0, 100.0, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitBuyOrderSave() {
	// when: a limit order is sent to an empty matching unit
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Buy, 10, 100, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitNoMatchCaseIncomingBuy() {
	...
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Sell, 10, 100, "GTC")
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Buy, 9, 100, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitNoMatchCaseIncomingSell() {
	...
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Buy, 9, 100, "GTC")
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Sell, 10, 100, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitExactMatchIncomingBuy() {
	...
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Buy, 10, 100, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchIncomingBuySingleTrade() {
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Sell, 10.00, 100.00, "GTC")
	...
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Buy, 10.00, 50.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitOverflowMatchIncomingBuySingleTrade() {
	// when: there is a SELL order in the book
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Sell, 10.00, 10.00, "GTC")
	...
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Buy, 10.00, 15, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchIncomingSellSingleTrade() {
	...
	ProcessTradeOrder(Acc(), "BTC_EUR", "LIMIT", models.Buy, 10.00, 100.00, "GTC")
	...
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Sell, 10.00, 50.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitOverflowMatchIncomingSellSingleTrade() {
	...
	ProcessTradeOrder(Acc2(), "BTC_EUR", "LIMIT", models.Sell, 10.00, 150.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitExactMatchIncomingBuysMultipleTrades() {
	...
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitExactMatchIncomingSellMultipleTrades() {
	...
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 10.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 10.00, 5.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchMultipleBookSellsToMultipleTrades() {
	...
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 50.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 50.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 10.00, 75.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchMultipleBookBuysToMultipleTrades() {
	...
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 50.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 50.00, "GTC")
	...
	// when: incoming SELL order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 10.00, 75.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitExactMatchMultipleBookSellsToMultipleTrades() {
	...
	// when:
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 10.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 10.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 10.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 10.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 10.00, 40.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitExactMatchMultipleBookBuyToMultipleTrades() {
	...
	// when:
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 5.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 10.00, 20.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitIncompleteMatchMultipleBookSellsToMultipleTrades() {
	...
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 5.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 5.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 10.00, 17, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitIncompleteMatchMultipleBookBuysToMultipleTrades() {
	...
	// when: incoming SELL order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 10.00, 175.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchMultipleBookSellsToMultipleTradesMultiplePrices() {
	...
	// when: there are multiple SELL orders in the book and BUY limit order arrive that cross but can fill only partially one of the orders
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 9.00, 50.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Sell, 10.00, 50.00, "GTC")
	...
	// when: incoming buy order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Buy, 11.00, 75.00, "GTC")
...
func (assert *ServiceTestSuite) TestProcessLimitPartialMatchMultipleBookBuysToMultipleTradesMultiplePrices() {
	...
	// when: there are multiple BUY orders in the book and SELL limit order arrive that cross but can fill only partially one of the orders
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 9.00, 50.00, "GTC")
	ProcessTradeOrder(tradingAccount, "BTC_EUR", "LIMIT", models.Buy, 10.00, 50.00, "GTC")
	...
	// when: incoming SELL order is only partially matched
	ProcessTradeOrder(tradingAccount2, "BTC_EUR", "LIMIT", models.Sell, 8.00, 75.00, "GTC")
