...
CREATE TABLE trade_order(
    ...
    instrument_account_id  BIGINT REFERENCES instrument_account(id) NOT NULL,
...
CREATE INDEX idx_trade_order_instrument_account_id ON trade_order(instrument_account_id);
